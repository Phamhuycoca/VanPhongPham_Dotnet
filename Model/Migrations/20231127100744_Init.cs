            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SanPhamId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SanPhamTen = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SanPhamHinhAnh = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SanPhamGia = table.Column<int>(type: "int", nullable: false),
                    SanPhamNguonGoc = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LoaiSanPhamId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
